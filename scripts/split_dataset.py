...
with open(csv_file, 'r') as original_csv, open(train_csv, 'w', newline='') as train_csvfile, open(test_csv, 'w', newline='') as test_csvfile:
    ...
    for i, row in enumerate(reader):
        ...
        shutil.copy(os.path.join(data_path, image_filename), os.path.join(dest_folder, image_filename))
