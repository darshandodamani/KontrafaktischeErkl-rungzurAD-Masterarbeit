...
print(f'YOLO model version: {model._version}')  # Print the version of YOLOv5 being used

# Define classes to mask (e.g., vehicles, pedestrians, traffic lights, traffic signs)
classes_to_mask = ['car', 'truck', 'bus', 'motorcycle', 'bicycle', 'person', 'traffic light', 'stop sign']
