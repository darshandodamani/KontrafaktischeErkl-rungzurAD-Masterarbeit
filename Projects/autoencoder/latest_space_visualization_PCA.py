...
from mpl_toolkits.mplot3d import Axes3D  # Import 3D plotting capabilities if you want 3D
...
sc = ax.scatter(latent_3d_pca[:, 0], latent_3d_pca[:, 1], latent_3d_pca[:, 2], c=labels, cmap='viridis', marker='o')
plt.colorbar(sc)
